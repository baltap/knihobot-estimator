...
Knihobot's growth bottleneck is *acquiring* books, and the loudest reason sellers
...
- **Primary user:** someone with a shelf of read books wondering *"is it even worth
  the hassle to sell these?"*
- **The job:** remove uncertainty *before* commitment. This is NOT "list my books"
...
2. Radical **transparency** about the commission math and *why* a price is what it is.
...
1. **Ranges, never false precision.** Show a price *range* with the number of
...
3. **Warn before they commit.** Flag oversupplied / likely-to-be-declined titles
   *up front* ("Knihobot already has many copies of this — it may be declined or
...
1. **Land** → headline: *"Find out what your books are worth — before you send them."*
...
4. **Aggregate** headline: *"Your 12 books → est. payout 340–520 CZK,"* with a clean
   per-book breakdown.
...
- **Brand:** Knihobot green `#264D39` as the primary; clean, calm, trustworthy —
  this is a tool about *trust*, so the visual tone should feel honest, not salesy.
